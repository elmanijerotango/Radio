...
// ══════════════════════════════════════════════════════════════════════════
// AUDIO — cuando termina, pregunta al backend qué sigue
// ══════════════════════════════════════════════════════════════════════════
...
function reproducirAudio(tema, offsetSeg) {
  ...
  el.addEventListener('canplaythrough', function onReady() {
    ...
    // Cortina: fade y al terminar → sincronizar con backend
  ...
  // Tema terminó naturalmente → sincronizar con backend
...
console.log('El Manijero Radio v2.0 · listo');
